...
\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/4.PNG}}
\caption{code 4 hasil}
\label{proses4}
\end{figure}

\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/5.PNG}}
\caption{code 5 hasil}
\label{proses5}
\end{figure}

\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/6.PNG}}
\caption{code 6 hasil}
\label{proses6}
\end{figure}

\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/7.PNG}}
...
\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/8.PNG}}
\caption{code 8 hasil}
\label{proses8}
\end{figure}

\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/9.PNG}}
\caption{code 9 hasil}
\label{proses9}
\end{figure}

\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/10.PNG}}
...
\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/21.PNG}}
\caption{Error Path}
\label{proses21}
\end{figure}

\begin{figure}
\centerline{\includegraphics[width=1\textwidth]{figures/fathi/chapter3/22.PNG}}
\caption{Fix Error}
\label{proses22}
\end{figure}
